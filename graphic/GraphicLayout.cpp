...
void GraphicLayout::createDescriptorSetLayout() {
...
void GraphicLayout::createPipeline() {
	...
	bindingDescriptions[0].stride = sizeof(GraphicVertex);
	...
	attributeDescriptions[0].offset = offsetof(GraphicVertex, pos);
	attributeDescriptions[1].binding = 0;
	attributeDescriptions[1].location = 1;
	attributeDescriptions[1].format = VK_FORMAT_R32G32_SFLOAT;
	attributeDescriptions[1].offset = offsetof(GraphicVertex, texCoord);
